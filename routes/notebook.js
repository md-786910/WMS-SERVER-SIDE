...
const { createFile, getAllFiles, createNotebook, getContentNotebook, deleteFiles, updateOrderNotebookFiles, updateNoteBookTitle } = require("../controller/notebookController");
...
notebookRouter.patch("/notebook-files/:fileId", updateNoteBookTitle);
