...
const { addCompany, addCompanyTask, getCompany, getCompanyTask, deleteCompany, completeTask, getCompanyById, updateCompany } = require('../controller/compantController');
